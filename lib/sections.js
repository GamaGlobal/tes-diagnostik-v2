...
export const DURATIONS = {
  // MEMORIZE dipersingkat (180->110 smp, 150->90 sma) — dipadukan dengan
  // JUMLAH_VERSI_MEMORI varian pasangan berbeda per siswa (lib/anti-curang.js
  // & app/api/attempt/start) supaya waktu tidak cukup dipakai mencatat
  // seluruh daftar dengan tenang, dan catatan tetangga pun tidak cocok.
  smp: { SE:360, WA:360, AN:420, GE:480, RA:600, ZR:600, FA:420, WU:540, MEMORIZE:110, ME:360 },
  sma: { SE:360, WA:360, AN:420, GE:480, RA:720, ZR:660, FA:360, WU:480, MEMORIZE:90, ME:330 },
};
