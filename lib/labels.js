...
export const BAKAT_LABELS = {
  ...
  AGM: 'Ilmu Keagamaan (Tafsir-Hadis-Fiqih)'
};
// Deskripsi & rekomendasi mapel pilihan kelas XI disamakan dengan daftar resmi
// "Komponen Mapel Pendukung" sekolah (Ilmu Tafsir, Ilmu Hadis, Ushul Fiqih,
// B.Arab TL, B.Indo TL, B.Inggris TL, MTK TL, Kimia, Fisika, Biologi,
// Informatika, Ekonomi, Geografi, Sosiologi, Sejarah TL, Keterampilan).
export const BAKAT_DESC_SMA = {
  MIPA: 'Kuat di penalaran matematis & sains. Mapel pilihan yang relevan: Matematika Tingkat Lanjut (MTK TL), Fisika, Kimia, Biologi.',
  IPS: 'Kuat di pemahaman fenomena sosial-ekonomi. Mapel pilihan yang relevan: Ekonomi, Geografi, Sosiologi, Sejarah Tingkat Lanjut (Sejarah TL).',
  BHS: 'Kuat di bahasa & sastra. Mapel pilihan yang relevan: Bahasa Indonesia Tingkat Lanjut (B.Indo TL), Bahasa Inggris Tingkat Lanjut (B.Inggris TL).',
  INF: 'Kuat di logika komputasional. Mapel pilihan yang relevan: Informatika.',
  VOK: 'Kuat di keterampilan teknis-praktis. Mapel pilihan yang relevan: Keterampilan.',
  AGM: 'Kuat di pemahaman teks & penalaran keagamaan. Mapel pilihan yang relevan: Ilmu Tafsir, Ilmu Hadis, Ushul Fiqih, Bahasa Arab Tingkat Lanjut (B.Arab TL).'
};
export const BAKAT_DESC_SMP = {
  ...
  AGM: 'Kuat di pemahaman teks & penalaran keagamaan. Arahkan bakat ini lewat: kajian tafsir/hadis, tahfiz, muhadatsah bahasa Arab, atau ekstrakurikuler kerohanian.'
};
